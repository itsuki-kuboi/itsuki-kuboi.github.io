...
<ul>
  ...
  <li><b>Paper/Proceedings Paper/Preprint Paper</b>
    ...
    <br>
      <li>
        ...
        <br>Vol. 2023-MPS-145, Num. 3, pp. 1-6,  
        <!-- <br>MPS, IPSJ, -->
        <!-- <br>Tokyo, Japan, -->
        <br>2023.8.31,
    ...
    <br>
      <li>
        ...
        <br>"Iterative Censoring and Highly Efficient Machine Learning with Condition Number in LSMR Method",
        <br>IPSJ SIG Technical Reports,
        <br>Vol. 2023-MPS-144, Num. 10, pp. 1-4,  
        <!-- <br>MPS, IPSJ, -->
        <!-- <br>Tokyo, Japan, -->
        <br>2023.7.17,
    ...
    <br>
      ...
      <li>
        ...
        <br>IPSJ SIG Technical Reports,
        <br>Vol. 2023-MPS-142, Num. 31, pp. 1-6,  
        <!-- <br>MPS, IPSJ, -->
        <!-- <br>Tokyo, Japan, -->
        <br>2023.3.2,
      ...
      <li>
        ...
        <br>"On a Fast Computation of the Condition L-curve in the LSMR Method for Solving Ill-conditioned Problems using the DQDS Method",
        <br>IPSJ SIG Technical Reports,
        <br>Vol. 2022-MPS-139, Num. 3, pp. 1-4,  
        <!-- <br>MPS, IPSJ, -->
        <!-- <br>Tokyo, Japan, -->
        <br>2022.7.19,
    ...
    <br>
      <li>
        Miho Chiyonobu*, Itsuki Kuboi, Rika Tanaka, Shin-ya Ozawa, Yohsuke Hosoda, Masami Takata, Kinji Kimura and Yoshimasa Nakamura,
              <br>(千代延未帆*, 久保井五貴, 田中利佳, 小澤伸也, 細田陽介, 高田雅美, 木村欣司, 中村佳正),
        <br>"Proposal on how to reduce the number of data when implementing deep learning of stop conditions for the LSMR method",
        <br>(LSMR法の停止条件を深層学習する際のデータ数削減方法に関する提案),
        <br>MPS142,
        <br>MPS, IPSJ,
  ...
  <br>
  <li><b>Notation of Paper</b>
    <ol reversed>
    
      <!-- <br> -->
      <li>
        Author,
        <br>(Official Expression unless English Expression),
        <br>"Publication",
        <br>(Official Expression unless English Expression),
        <br>Journal or Conference,
        <br>Volume, Number, Page Range
        <br>Issue Date
        <br>URL or DOI
      </li>
    </ol>
  ...
  <li><b>Notation of Presentation</b>
    <ol reversed>
      <!-- <br> -->
      <li>
        Author,
